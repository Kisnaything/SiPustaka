...
const dummyPeminjaman = [
  {
    ...
    buku: [
      { judul: 'Pemrograman Web Modern', coverColor: '#C8B89A' },
      { judul: 'Basis Data Lanjutan', coverColor: '#6B7E8F' },
      { judul: 'Algoritma & Struktur Data', coverColor: '#374151' },
    ],
    tanggalPinjam: '12 Jun 2026', jatuhTempo: '26 Jun 2026', status: 'Aktif',
  },
  {
    ...
    tanggalPinjam: '10 Jun 2026', jatuhTempo: '24 Jun 2026', status: 'Menunggu Verifikasi',
  },
  {
    id: '3', kode: 'PJM-2026-0312',
    buku: [
      { judul: 'Algoritma & Struktur Data', coverColor: '#374151' },
      { judul: 'Kalkulus', coverColor: '#1E293B' },
    ],
    tanggalPinjam: '07 Jun 2026', jatuhTempo: '21 Jun 2026', status: 'Terlambat',
  },
  {
    ...
    tanggalPinjam: '05 Jun 2026', jatuhTempo: '19 Jun 2026', status: 'Selesai',
  },
]
...
export default function PeminjamanPage() {
  ...
  const filtered = dummyPeminjaman.filter((p) => {
    const matchTab = activeTab === 'Semua' || p.status === activeTab
    const matchSearch =
      p.kode.toLowerCase().includes(search.toLowerCase()) ||
      p.buku.some((b) => b.judul.toLowerCase().includes(search.toLowerCase()))
    return matchTab && matchSearch
  })

  return (
    <div style={{ padding: '32px', fontFamily: "'Plus Jakarta Sans', sans-serif", maxWidth: '1280px' }}>
      ...
      {/* Tabs + Search */}
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0', borderBottom: '1px solid #E5E7EB' }}>
        {/* Tabs */}
      ...
      <div style={{
        ...
        <div style={{
          ...
          {['No. Peminjaman', 'Buku', 'Tanggal Pinjam', 'Jatuh Tempo', 'Status', 'Aksi'].map((h) => (
            <span key={h} style={{ fontSize: '13px', fontWeight: 500, color: '#374151', letterSpacing: '0.02em' }}>
              {h}
            </span>
          ))}
        </div>
        ...
        {filtered.length === 0 ? (
          <div style={{ padding: '48px', textAlign: 'center', color: '#6B7280' }}>
            <p style={{ fontSize: '14px', margin: '0 0 8px', fontWeight: 600, color: '#374151' }}>
          ...
          filtered.map((item, i) => (
            ...
            >
              {/* No. Peminjaman */}
              <span style={{ fontSize: '13px', fontWeight: 500, color: '#374151', fontVariantNumeric: 'tabular-nums' }}>
                {item.kode}
              </span>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                ...
                <div style={{
                  ...
                  backgroundColor: item.buku[0].coverColor,
                  borderRadius: '4px',
                }} />
                <div>
                  {/* Judul buku pertama, dipotong kalau terlalu panjang */}
                  <span style={{
                  ...
                  {/* Badge +N lainnya kalau lebih dari 1 buku */}
                  {item.buku.length > 1 && (
                    <span style={{
